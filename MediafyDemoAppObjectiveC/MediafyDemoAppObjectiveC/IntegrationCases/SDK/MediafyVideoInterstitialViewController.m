...
@interface MediafyVideoInterstitialViewController ()

@property (nonatomic) MediafyInterstitialAdUnit * interstitialAdUnit;

@end

@implementation MediafyVideoInterstitialViewController
...
- (void)loadAd {
    ...
    self.interstitialAdUnit.adFormats = [NSSet setWithArray:@[MediafyAdFormat.video]];
    self.interstitialAdUnit.adSizes = @[[NSValue valueWithCGSize:CGSizeMake(1024, 768)]];
