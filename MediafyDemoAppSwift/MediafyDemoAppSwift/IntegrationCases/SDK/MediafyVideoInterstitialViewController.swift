...
final class MediafyVideoInterstitialViewController: InterstitialBaseViewController {
    ...
    private func loadAd() {
        ...
        interstitialAdUnit.adSizes = [CGSize(width: 1024, height: 768)]
...
extension MediafyVideoInterstitialViewController: MediafyInterstitialAdUnitDelegate {
