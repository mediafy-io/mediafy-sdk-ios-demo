...
final class MediafyBannerAdMultisizeViewController: AdBaseViewController {
    ...
    private func loadAd() {
        ...
        adView.adSizes = [CGSize(width: 320, height: 50), CGSize(width: 728, height: 90)]
...
extension MediafyBannerAdMultisizeViewController: MediafyAdViewDelegate {
    ...
    func adView(_ adView: MediafyAdView, didReceiveAdWithAdSize adSize: CGSize) {
        ...
        adView.frame = CGRect(origin: .zero, size: adSize)
